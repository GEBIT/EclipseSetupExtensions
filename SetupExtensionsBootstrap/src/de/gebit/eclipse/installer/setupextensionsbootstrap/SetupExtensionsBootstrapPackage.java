 ...
 *        annotation="http://www.eclipse.org/oomph/setup/Enablement variableName='p2.setup.extensions' repository='https://github.com/GEBIT/EclipseSetupExtensions/wiki/updates/' installableUnits='SetupExtensionsBootstrap.feature.group[1.1.1,2.0.0)'"
 * @generated
 */
public interface SetupExtensionsBootstrapPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link de.gebit.eclipse.installer.setupextensionsbootstrap.impl.IncludeTaskImpl <em>Include Task</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.gebit.eclipse.installer.setupextensionsbootstrap.impl.IncludeTaskImpl
   * @see de.gebit.eclipse.installer.setupextensionsbootstrap.impl.SetupExtensionsBootstrapPackageImpl#getIncludeTask()
   * @generated
   */
  int INCLUDE_TASK = 2;
   ...
   * @ordered
   */
  int INCLUDE_TASK__ANNOTATIONS = SetupPackage.SETUP_TASK__ANNOTATIONS;
   ...
   * @ordered
   */
  int INCLUDE_TASK__ID = SetupPackage.SETUP_TASK__ID;
   ...
   * @ordered
   */
  int INCLUDE_TASK__DESCRIPTION = SetupPackage.SETUP_TASK__DESCRIPTION;
   ...
   * @ordered
   */
  int INCLUDE_TASK__SCOPE_TYPE = SetupPackage.SETUP_TASK__SCOPE_TYPE;
   ...
   * @ordered
   */
  int INCLUDE_TASK__EXCLUDED_TRIGGERS = SetupPackage.SETUP_TASK__EXCLUDED_TRIGGERS;
   ...
   * @ordered
   */
  int INCLUDE_TASK__DISABLED = SetupPackage.SETUP_TASK__DISABLED;
   ...
   * @ordered
   */
  int INCLUDE_TASK__PREDECESSORS = SetupPackage.SETUP_TASK__PREDECESSORS;
   ...
   * @ordered
   */
  int INCLUDE_TASK__SUCCESSORS = SetupPackage.SETUP_TASK__SUCCESSORS;
   ...
   * @ordered
   */
  int INCLUDE_TASK__RESTRICTIONS = SetupPackage.SETUP_TASK__RESTRICTIONS;
   ...
   * @ordered
   */
  int INCLUDE_TASK__FILTER = SetupPackage.SETUP_TASK__FILTER;

  /**
   * The number of structural features of the '<em>Include Task</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int INCLUDE_TASK_FEATURE_COUNT = SetupPackage.SETUP_TASK_FEATURE_COUNT + 0;
  ...
  /**
   * Returns the meta object for class '{@link de.gebit.eclipse.installer.setupextensionsbootstrap.IncludeTask <em>Include Task</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Include Task</em>'.
   * @see de.gebit.eclipse.installer.setupextensionsbootstrap.IncludeTask
   * @generated
   */
  EClass getIncludeTask();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link de.gebit.eclipse.installer.setupextensionsbootstrap.impl.IncludeTaskImpl <em>Include Task</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.gebit.eclipse.installer.setupextensionsbootstrap.impl.IncludeTaskImpl
     * @see de.gebit.eclipse.installer.setupextensionsbootstrap.impl.SetupExtensionsBootstrapPackageImpl#getIncludeTask()
     * @generated
     */
    EClass INCLUDE_TASK = eINSTANCE.getIncludeTask();

...
//
//
package de.gebit.eclipse.installer.executecommand.util;
 ...
 * @generated
 */
public class ExecuteCommandAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static ExecuteCommandPackage modelPackage;
   ...
   * @generated
   */
  public ExecuteCommandAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = ExecuteCommandPackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected ExecuteCommandSwitch<Adapter> modelSwitch = new ExecuteCommandSwitch<Adapter>()
  {
    @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.gebit.eclipse.installer.executecommand.ExecuteCommandTask <em>Task</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.gebit.eclipse.installer.executecommand.CommandParameter <em>Command Parameter</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
